...
export async function generateCertificate(
  ...
  if (!logoImage) {
    throw new Error(
      "CloudLearn logo could not be loaded."
    );
  }
...
/* ==========================================================
  ...
  centerText(
    page,
    "has successfully completed the comprehensive learning path",
    sans,
    10,
    264,
    muted,
  ...
  centerText(
    page,
    "CLOUDLEARN COURSE & FINAL TEST COMPLETED SUCCESSFULLY",
    sansBold,
    6.7,
    173,
    navy,
  ...
  const signatureScale =
    Math.min(
      105 / signatureImage.width,
      31 / signatureImage.height
    );
