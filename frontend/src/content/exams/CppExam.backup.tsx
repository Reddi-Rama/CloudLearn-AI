...
export default function CppExam() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 pt-28 pb-8 dark:bg-slate-950">
      <div className="mx-auto max-w-7xl">
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
            25 questions â€¢ Passing score: 18/25 â€¢ No time limit
          </p>
        </div>
                    ...
                    <button
                      ...
                      className={`flex w-full items-start gap-4 rounded-xl border p-4 text-left transition ${
                        selected
                          ...
                          : "border-slate-200 hover:border-slate-400 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800"
                      }`}
                    >
                      <span
