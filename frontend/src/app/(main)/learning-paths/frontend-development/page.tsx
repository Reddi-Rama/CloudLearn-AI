...
import frontendDevelopmentPath from "@/content/learningpaths/frontendDevelopment/text";

export default function FrontendDevelopmentPage() {
  const path = frontendDevelopmentPath;
        ...
        <section className="min-w-0 flex-1">
          ...
          >
            <div className="mx-auto w-full max-w-[1250px]">
              ...
              <p className="mt-6 text-xl font-medium leading-8 text-slate-300 lg:text-2xl">
                {path.subtitle}
              </p>
            ...
            <div className="mx-auto w-full max-w-[1250px]">
              ...
              >
                ...
                <h2 className="mt-2 text-3xl font-bold text-white md:text-4xl">
                  From Beginner to Advanced Engineering
                </h2>

                <div className="mt-10 space-y-5">

                  {path.projectProgression.map((project, index) => (
                    <div
                      key={`${project}-${index}`}
                      className="
                        flex
