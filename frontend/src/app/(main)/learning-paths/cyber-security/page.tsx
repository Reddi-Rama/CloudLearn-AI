...
import cyberSecurityPath from "@/content/learningpaths/cyberSecurity/text";

export default function CyberSecurityPage() {
  const path = cyberSecurityPath;
            ...
            <div className="mx-auto w-full max-w-[1250px]">
              ...
              >
                ...
                <h2 className="mt-2 text-3xl font-bold text-white md:text-4xl">
                  From Security Foundations to Enterprise Security
                </h2>
              ...
              >
                ...
                <h2 className="mt-2 text-3xl font-bold text-white md:text-4xl">
                  Your Cybersecurity Progression
                </h2>
